...
class UpdateRooms(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.entry_room_id = PhotoImage(file=relative_to_assets("entry_1.png"))
        entry_id_bg = self.canvas.create_image(
            212.8127899169922, 288.0, image=self.entry_room_id
        )
        entry_id = Entry(
            self,
        ...
        entry_id.place(x=72, y=172.0, width=282.49761962890625, height=22.0)
    ...
    def handle_update(self):
        ...
        if result:
            ...
            messagebox.showerror(
                "Error", "Failed to update details. Room Number does not exist"
            )
