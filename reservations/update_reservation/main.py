...
class UpdateReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        entry_image_bg = self.canvas.create_image(
            149.5, 258.0, image=self.id_entry_image
        )
        id_entry = Entry(
            self,
            bd=0,
        ...
        id_entry.place(x=60.0, y=150.0, width=179.0, height=22.0)
    ...
    def reset(self):
        ...
        self.canvas.itemconfigure(self.id_text, text="Select source first...")
