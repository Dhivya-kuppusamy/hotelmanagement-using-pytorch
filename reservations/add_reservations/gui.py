...
class AddReservations(Frame):
    ...
    def save(self):
        ...
        # get the reservation id from mysql as the last inserted id
        self.parent.reservation_id = db_controller.get_last_reservation()
        # show the billing screen
        self.parent.navigate("bill")
